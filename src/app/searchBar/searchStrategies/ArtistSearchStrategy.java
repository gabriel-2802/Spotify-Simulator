...
/**
 * This class is used to search for artists
 */
public class ArtistSearchStrategy implements SearchStrategy<User> {
    /**
    ...
    public List<User> search(final Filters filters, final List<String> names,
        ...
        List<User> entries = FilterUtils.filterArtists(admin.getArtists(), filters.getName());
