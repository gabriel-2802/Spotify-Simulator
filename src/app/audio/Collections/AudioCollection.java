...
public abstract class AudioCollection extends LibraryEntry {
    ...
    /**
     * Contains media by creator boolean.
     * @param creator the creator
     * @return true if the creator is in the collection, false otherwise
     */
    public abstract boolean containsMediaByCreator(String creator);
}
